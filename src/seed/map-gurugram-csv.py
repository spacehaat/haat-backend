#!/usr/bin/env python3
"""Map Gurugram workspace CSV → listing JSON for seed-gurugram-csv.ts."""
...
CSV_PATH = Path(__file__).resolve().parents[4] / "gurugram-workspaces-2026-07-24.csv"
OUT_PATH = Path(__file__).resolve().parent / "gurugram-csv-listings.json"
